---
title: "305 Lecture 25 - Learning from Evidence"
...
- But I'm going to start with an interesting example that might not seem to have much to do with probability at all.
- Instead it's an interesting, and somewhat famous, story about learning.
